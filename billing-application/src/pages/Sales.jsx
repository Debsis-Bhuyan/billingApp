  ...
  return (
    <div style={styles.container}>
      <div style={styles.toggleButton} onClick={toggleView}>
        ...
        <span style={{ marginLeft: '10px' }}>{view ? "Switch to Service Details" : "Switch to Product Details"}</span>
      </div>
      {view ? (
        <div>
          <div style={styles.addItemSection}>
            ...
            <div style={styles.itemDetailsContainer}>
              <input type="text" placeholder="Item Name" style={styles.itemInput} />
              <input type="text" placeholder="Item HSN No" style={styles.itemInput} />
            ...
            <div style={styles.additionalDetailsContainer}>
              <input type="text" placeholder="Category" style={styles.itemInput} />
              <input type="text" placeholder="Item Code" style={styles.itemInput} />
              <input type="file" accept="image/*" style={styles.itemInput} />
            </div>
          </div>
          <hr style={styles.hr} />
          <div style={styles.salesPriceSection}>
            ...
            <div style={styles.salesPriceContainer}>
              <input type="text" placeholder="Sales Price" style={styles.saleInput} />
              <select style={styles.selectWithoutTax}>
                <option value="Yes">Without Tax</option>
                <option value="No">With Tax</option>
              </select>
              <input type="text" placeholder="Disc. on Sales Price" style={styles.discountInput} />
          ...
          <div style={{ margin: "10px 0" }}>
            <button style={styles.addWholesalePriceBtn} onClick={handleAddWholesalePrice}>
              +ADD WHOLESALE PRICE
            </button>
          ...
          <div className="flex item-center pt-4 py-2 my-4 border justify-between">
            <div className="mx-8 border" style={styles.additionalInfoSection}>
              ...
              <div>
                <input type="text" placeholder="Purchase Price" style={styles.discountInput} />
                <select style={styles.selectWithoutTax}>
                  <option value="Yes">Without Tax</option>
                  <option value="No">With Tax</option>
                </select>
        ...
        <div>
          <div style={styles.addItemSection}>
            <div style={styles.itemDetailsContainer}>
              <input type="text" placeholder="Service Name" style={styles.itemInput} />
              <input type="text" placeholder="Service HSN No" style={styles.itemInput} />
              <select style={styles.selectUnit}>
                <option value="">Select Unit</option>
                <option value="unit1">Unit 1</option>
                <option value="unit2">Unit 2</option>
            ...
            <div style={styles.additionalDetailsContainer}>
              <input type="text" placeholder="Category" style={styles.itemInput} />
              <input type="text" placeholder="Service Code" style={styles.itemInput} />
              <input type="file" accept="image/*" style={styles.itemInput} />
            </div>
          </div>
          <hr style={styles.hr} />
